function [h, a_ff, r, theta_MEASURE] = LVF(r_T, o_hat, q, v_max, theta_d, w_OI, vt_I, a_prime, finalAngle, vC_T, at_I, w_dot_OI, d_B, o_hat_B, CT_BI)
...
%             r_T_measure = r_T + o_hat*0.5; % One centimeter back in the o_hat direction!
%             r_measure = sqrt(sum(r_T_measure.^2));
%             theta_MEASURE = acos((r_T_measure'*o_hat)/(r_measure*o_mag));
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
